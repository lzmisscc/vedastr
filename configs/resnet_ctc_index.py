...
size = (32, 100)
mean, std = 0.5, 0.5
max_classes_nums = 265
character = [str(i+1) for i in range(max_classes_nums)]
sensitive = True
batch_max_length = 30
...
train_dataset_st = [
    dict(type='IndexDataset', root="/data/lz/GitHub/table_ocr/data/train",
         gt_txt="/data/lz/GitHub/table_ocr/index_train.txt", **test_dataset_params)
]
# valid
# valid_root = data_root + 'validation/'
# valid_dataset = dict(type='LmdbDataset', root=valid_root, **test_dataset_params)
valid_dataset = dict(type='IndexDataset', root="/data/lz/GitHub/table_ocr/data/val",gt_txt="/data/lz/GitHub/table_ocr/index_val.txt",
         **test_dataset_params)
